...
def item_appraisal():
    ...
    # title
    title = tk.Label(a, text="Item Registry", bg="white", fg="black",
                     font="Times 32")
    title.grid(column=1, row=0)

    # search
    searchLabel = tk.Label(a, text="Search item: ", bg="white", fg="black",
    ...
    searchButton = tk.Button(a, text="Search", font="Times 18", bg="white",
    ...
    # search results
    LitemNum = tk.Label(b, text="Item#", bg="white", fg="black",
                        font="Times 12", borderwidth=1, relief="solid",
                        width=10)
    LitemNum.grid(column=0, row=0)
    Lcategory = tk.Label(b, text="Category", bg="white", fg="black",
                         font="Times 12", borderwidth=1, relief="solid",
                         width=20)
    Lcategory.grid(column=1, row=0)
    Ldescription = tk.Label(b, text="Description", bg="white", fg="black",
                            font="Times 12", borderwidth=1, relief="solid",
                            width=50)
    Ldescription.grid(column=2, row=0)
    Lrisk = tk.Label(b, text="Risk Level", bg="white", fg="black",
                     font="Times 12", borderwidth=1, relief="solid", width=10)
    Lrisk.grid(column=3, row=0)
    Lamount = tk.Label(b, text="Amount", bg="white", fg="black",
                       font="Times 12", borderwidth=1, relief="solid",
                       width=10)
    ...
    back = tk.Button(a, text="Go Back", font="Times 18", bg="white",
                     fg="black", command=goBack)
...
def regCustomer():
    ...
    # title
    title = tk.Label(a, text="Customer Information", bg="white", fg="black",
                     font="Times 32")
    title.grid(column=1, row=0)
    ...
    # labels
    LcustomerID = tk.Label(b, text="Customer ID", bg="white", fg="black",
                           font="Times 12", borderwidth=1, relief="solid")
    LlastName = tk.Label(b, text="Last Name", bg="white", fg="black",
                         font="Times 12", borderwidth=1, relief="solid")
    LgivenName = tk.Label(b, text="Given Name", bg="white", fg="black",
                          font="Times 12", borderwidth=1, relief="solid")
    LmiddleInitial = tk.Label(b, text="MI", bg="white", fg="black",
                              font="Times 12", borderwidth=1, relief="solid")
    Laddress = tk.Label(b, text="Address", bg="white", fg="black",
                        font="Times 12", borderwidth=1, relief="solid")
    Lcity = tk.Label(b, text="City", bg="white", fg="black", font="Times 12",
                     borderwidth=1, relief="solid")
    Lmobile = tk.Label(b, text="Mobile", bg="white", fg="black",
                       font="Times 12", borderwidth=1, relief="solid")
    Llandline = tk.Label(b, text="Landline", bg="white", fg="black",
                         font="Times 12", borderwidth=1, relief="solid")
    LpostalCode = tk.Label(b, text="Postal Code", bg="white", fg="black",
                           font="Times 12", borderwidth=1, relief="solid")
    LbirthDate = tk.Label(b, text="Birth Date", bg="white", fg="black",
                          font="Times 12", borderwidth=1, relief="solid")
...
# title label
blank = tk.Label(f, text="             ", bg="white", font="Times 32",
                 width=13)
title = tk.Label(f, text="VENTURE UNION", bg="white", fg="black",
                 font="Times 32")
blank.grid(column=0, row=0)
title.grid(column=1, row=0)

# item appraisal
itemAppraisalButton = tk.Button(f, text="Find an Item", font="Times 18",
                                bg="white", fg="black", command=item_appraisal)
itemAppraisalButton.grid(column=1, row=1)

# loan computation and releasing
findCustomer = tk.Button(f, text="Register a Customer", font="Times 18",
                         bg="white", fg="black", command=regCustomer)
findCustomer.grid(column=1, row=2)

newCustomer = tk.Button(f, text="Register a Customer", font="Times 18",
                        bg="white", fg="black", command=regCustomer)
newCustomer.grid(column=1, row=3)

# inventory management
inventoryTag = tk.Button(f, text="Create an Inventory Tag", font="Times 18",
                         bg="white", fg="black", command=item_appraisal)
newCustomer.grid(column=1, row=4)

# business processes
payment = tk.Button(f, text="Process a Payment", font="Times 18", bg="white",
                    fg="black", command=item_appraisal)
payment.grid(column=1, row=5)

extend = tk.Button(f, text="Extend a Loan", font="Times 18", bg="white",
                   fg="black", command=item_appraisal)
extend.grid(column=1, row=6)

expire = tk.Button(f, text="Report Expired Inventory", font="Times 18",
                   bg="white", fg="black", command=item_appraisal)
